...
def ModelKi(location, BASE_DIR):
    ...
    # Insert the model here, according to the loaded weights
    base_model = InceptionV3(weights='imagenet', include_top=False, input_shape=(150, 150, 3))
    # base_model = tf.keras.applications.densenet.DenseNet201(include_top=False, weights='imagenet',
    ...
    model = Sequential()
    model.add(Dense(1024, activation='relu', input_shape=(18432,)))  # 69120
    ...
    while (cap.isOpened()):
        ...
        if (frameId % math.floor(frameRate) == 0):
            ...
            filename = str(baseloc) + 'temp\\' + "_frame%d.jpg" % count;
            count += 1
    ...
    # converting features in one dimensional array 6*6*1920
